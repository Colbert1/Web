...
<xmp>
  <php session_start(); define('LOGIN','Julien'); $message='Bienvenue' ; if(!empty($_POST)) { if(empty($_POST['login'])) { $message='Indiquer votre login' ; } elseif($_POST['login'] !==LOGIN) { $message='Login Erreur ' ; } else { $message='Bienvenue ' . LOGIN .' !'; } } ?>
    <!DOCTYPE html>
    <html lang="en">
